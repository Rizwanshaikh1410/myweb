...
if(isset($_POST['forgot'])) {
    ...
    $mail->send();
    echo "<script>alert('OTP Sent to Your Email'); window.location.assign('otp.php?email=$email');</script>";
...
<div class="login">
         ...
         <p>By Clicking The Sign-Up Button, <br><br> You Agree To Our
           <a href="../pages/termsandcondition.html">Terms And Condition</a> And <a href="../pages/privacypolicy.html">Privacy Policy</a></p>
